...
import com.jinbooks.entity.TreeAttributes;
import com.jinbooks.entity.TreeNode;
import com.jinbooks.entity.idm.UserInfo;
import com.jinbooks.entity.permissions.Resources;
import com.jinbooks.entity.permissions.dto.ResourcesPageDto;
import com.jinbooks.persistence.service.HistorySystemLogsService;
import com.jinbooks.persistence.service.ResourcesService;
...
public class ResourcesController {
	...
	public Message<TreeAttributes> tree(@ModelAttribute Resources resource,@CurrentUser UserInfo currentUser) {
		...
		if (resourceList != null) {
			...
			TreeNode rootNode = new TreeNode("1","CeresCRM");
