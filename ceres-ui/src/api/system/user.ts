...
export function switchWorkspace(workspaceId : any): any {
  return request({
    url: '/users/switchWorkspace/'+workspaceId,
    method: 'get'
  })
}
...
// 查询用户账套列表
export function userAccessWorkspace(query : any): any {
  return request({
    url: '/permissions/permissionWorkspace/userAccessWorkspace',
    method: 'get',
    params: query
  })
}
...
// 查询用户无权账套列表
export function userNotAccessWorkspace(query : any): any {
  return request({
    url: '/permissions/permissionWorkspace/userNotAccessWorkspace',
    method: 'get',
    params: query
  })
}
...
// 添加未关联的账套
export function addAccessWorkspace(data : any): any {
  return request({
    url: '/permissions/permissionWorkspace/add',
    method: 'post',
    data: data
  })
}
...
// 删除关联的账套
export function deleteAccessWorkspace(query : any): any {
  return request({
    url: '/permissions/permissionWorkspace/delete',
    method: 'DELETE',
    params: query
  })
}
