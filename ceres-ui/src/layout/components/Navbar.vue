    ...
    <div class="right-menu">
      <div class="right-menu-item">
        ...
        <el-select
            ...
            style="width: 250px;">
          <el-option
              v-for="dict in currWorkspaceStore.setList"
              :key="dict.workspaceId"
              :label="dict.name"
              :value="dict.workspaceId"
          />
        </el-select>
      </div>
      <!--
...
import workspaceStore from '@/store/modules/workspaceStore'
...
const currentSet = computed({
  ...
  set: (id) => currWorkspaceStore.updateWorkspaceId(id),
});

currentSet.value = userStore.workspaceId;
console.log("currentSet "+currentSet.value);
...
function handleSwitchWorkspace(val: any) {
  console.log(currentSet.value)
  currentSet.value = val;
  userStore.workspaceId = val;
  userService.switchWorkspace(val).then((res: any) => {
    window.location.reload()
  })
}
